export function registerResources(server, api) {
    server.registerResource('global-config', 'mediamtx://config/global', {
        title: 'Global config',
    ...
    server.registerResource('path-defaults', 'mediamtx://config/pathdefaults', {
        title: 'Path defaults',
    ...
    server.registerResource('config-paths', 'mediamtx://config/paths', {
    ...
    server.registerResource('paths', 'mediamtx://paths', {
        title: 'Active paths',
    ...
    server.registerResource('hls-muxers', 'mediamtx://hls/muxers', {
        title: 'HLS muxers',
