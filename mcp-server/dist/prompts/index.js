...
export function registerPrompts(server) {
    server.registerPrompt('audit-paths', {
        title: 'Audit paths',
...
Flag anything anomalous: paths configured but never reached ready, paths ready but with no readers for an extended period, paths with a source that is no longer responding.`,
    ...
    server.registerPrompt('kick-stale-sessions', {
    ...
    server.registerPrompt('summarize-stream-health', {
    ...
    server.registerPrompt('new-path-from-rtsp', {
    ...
    server.registerPrompt('compare-config', {
